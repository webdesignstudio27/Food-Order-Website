                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="chat.php">
                                <img class="img-icon" src="images/chat.png"> Chat
                            </a>
                        </li>
                    ...
                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="fa fa-inr f-s-40">' . $r['price'] . '</span> <a href="dishes.php?res_id=' . $r['rs_id'] . '" class="btn theme-btn-dash pull-right"><span class="fa fa-shopping-cart f-s-40"/>Order Now</a> </div>
                                                </div>
